...
# Command:
  ...
  python3 train.py --not-restore-last
...
IMG_MEAN = np.array((103.939, 116.779, 123.68), dtype=np.float32)   ###(103.939, 116.779, 123.68)  26.7057, 36.6649, 28.4407

BATCH_SIZE = 2
DATA_DIRECTORY = './dataset/train/'    ######/media/dong/code/dataset_own/train/
DATA_LIST_PATH = './list_own/list_train'     ######./list_own/list_train.txt
IGNORE_LABEL = 0                                 ###255
INPUT_SIZE = '713,713'                           ###'713,713'
